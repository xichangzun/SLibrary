...
function amazonurl(unsignedUrl) {
    ...
    pairs.push("AWSAccessKeyId=0DEZ597MM061CSNGHVR2");
    pairs = encodeNameValuePairs(pairs);
    pairs.sort();
    var canonicalQuery = pairs.join("&");
    var stringToSign = "GET\n" + host + "\n/onca/xml\n" + canonicalQuery;

    var secret = "bkNkXDb9SAQHEA8SIPvHaEhYSP16mYlJE38QQAp7";
...
function addZero(n) {return ( n < 0 || n > 9 ? "" : "0" ) + n;}
