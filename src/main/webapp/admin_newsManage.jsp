                                ...
                                <figcaption>
                                    <div class="clearfix">
                                        <div style="width:80%;padding:10px 15px" class="f_left f_sm_none w_sm_full m_xs_bottom_10">
                                            <h4 class="fw_medium"><a href="#" class="color_dark">News Title1</a></h4>
                                        ...
                                        <div style="margin-top:8%" class="f_right f_sm_none t_align_r t_sm_align_l">
                                            ...
                                            <a href="admin_news_update.html"><button class="button_type_4 bg_light_color_2 tr_all_hover f_right r_corners color_dark mw_0 m_sm_left_5 p_hr_0 d_sm_inline_middle f_sm_none"><i class="fa fa-pencil"></i></button></a>
