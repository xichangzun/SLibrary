...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
	<head>
		<title>Handle Recommendation</title>
		<meta charset="utf-8">
								...
								<div class="col-lg-9 col-md-8 col-sm-8 m_xs_bottom_30">
									...
									<form>
                                    	<table style="font-size:16px">
                                            ...
                                            <tr id="handle_button" class="m_bottom_25">
                                                <td width="40" height="50" align="right" valign="middle">
                                                	<button class="button_type_4 tr_all_hover r_corners bg_scheme_color color_light f_mxs_none m_mxs_bottom_15" onclick="handle('adopt')">Adopt</button>
                                                </td>
                                                <td width="100" height="50" align="right" valign="middle">
                                                </td>
                                            	<td width="300" height="50"  valign="middle">
                                            		<button class="button_type_4 tr_all_hover r_corners bg_dark_color bg_cs_hover color_light f_mxs_none m_mxs_bottom_15" onclick="handle('reject')">Reject</button>
                                                </td>
                                            </tr>

											<input id="user_id" type="hidden" value=<%=recom.getUionPK().getUser_id()%> />
											<input id="ISBN" type="hidden" value=<%=recom.getUionPK().getISBN()%> />
