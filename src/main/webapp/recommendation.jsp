            ...
            <div class="container clearfix">
                ...
                <nav role="navigation" class="f_left f_xs_none d_xs_none">
                    <ul class="horizontal_list main_menu clearfix">
                        ...
                        <li class="relative current f_xs_none m_xs_bottom_5"><a id="nav3" href="#" class="tr_delay_hover color_light tt_uppercase"><b>Recommendation</b></a></li>
    ...
    <section class="breadcrumbs">
        <div class="container">
            <ul class="horizontal_list clearfix bc_list f_size_medium">
                ...
                <li><a href="#" class="default_t_color">Recommendation</a></li>
            </ul>
        </div>
    </section>
    <!--content-->
                        ...
                        <div class="col-lg-10 col-md-8 col-sm-8 m_xs_bottom_30">
                            ...
                            <form action="/Recommend/add" method="post">
                                ...
                                <ul>
                                    ...
                                    <li class="t_align_c">
                                        <button class="button_type_8 r_corners bg_scheme_color color_light tr_all_hove">Submit</button>
                                    </li>
                                    <li class="t_align_c">
                                        <h2 class="tt_uppercase color_dark m_bottom_25">&nbsp </h2>
                                    </li>
