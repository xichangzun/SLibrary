	...
	<body>
		...
		<script type="text/javascript">
			...
			$(document).ready(function(){
				...
				if(test == 1){
					//被接受荐购的标签
					$recContainer.append('<span class="hot_stripe"><img src="images/rec_pass.png" alt=""></span>');
				}else if(test == 2){
					//被拒荐购的标签
					$recContainer.append('<span class="hot_stripe"><img src="images/rec_reject.png" alt=""></span>');
				}
			})
		</script>
